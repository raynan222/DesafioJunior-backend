...
Revision ID: 0a70f4b317e3
Revises: 
Create Date: 2022-07-29 19:26:42.709968
...
def upgrade():
    ...
    sa.Column('acesso', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['acesso'], ['acesso.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('municipio', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['municipio'], ['municipio.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
